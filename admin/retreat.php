...
<body>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card" style="overflow:scroll;">
            <div class="card-body">
            <h4 class="card-title">Retreat List</h4>
        ...
        $(document).ready(function() {
            ...
            window.all = function() {
                        ...
                        $.ajax({
                            ...
                            url: 'retreat_all.php', // get the route value
                            ...
                            success: function(response) { //once the request successfully process to the server side it will return result here
                                ...
                                if (response.length) {
                                    ...
                                    $.each(response, function(key, value) {
                                        ...
                                        html += "<tr>" +
                                            "<td width='10%'><img src='./assets/retreat/" + value.banner + "' /></td>" +
                                            "<td width='20%'><b>" + value.title + "</b><br><span style='font-size:11px;'>"+ value.subtitle  +"<br>"+value.name+" "+value.housename+"</span></td>" +                                            
                                            "<td width='25%'>" + value.matter + "</td>" +
                                            "<td width='15%'>" + value.retreatstartdate + "-<br>"+ value.retreatenddate  +"<br><hr>Days: "+ value.nodays  +"</td>" +
                                            "<td width='5%'>" + value.venu + "</td>" +  
                                            "<td width='5%'>" + value.noseats + "</td>" +                                            
                                            "<td width='5%'>"+ value.orderno +"</td>" +
                                            "<td width='5%'>" + value.status + "</td>" +
                                            "<td width='10%'>" +                                            
                                            "<a href='retreat_edit.php?id="+value.id+"'><i class='fa fa-pencil-square-o pointer_link_blue' aria-hidden='true'></i></a>&nbsp;&nbsp;&nbsp;" +
					...
					callback: function(result) {
						if (result) {
							...
							$.ajax({
								...
								url: "retreat_delete.php?delid=" + id, // get the route value								
