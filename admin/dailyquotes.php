...
<body>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card" style="overflow:scroll;">
            <div class="card-body">
            <h4 class="card-title">Daily Quotes List</h4>
            <!--<p class="card-description"> ADD <code></code>-->
            <a href="dailyquotes_add.php"><input type="button" name="btnNews" id="btnNews" value="New" class="btn btn-primary"></a>
            </p>
        ...
        $(document).ready(function() {
            ...
            window.all = function() {
                        ...
                        $.ajax({
                            ...
                            url: 'dailyquotes_all.php', // get the route value
                                ...
                                if (response.length) {
                                    ...
                                    $.each(response, function(key, value) {
                                        ...
                                        html += "<tr>" +
                                            ...
                                            "<td width='10%'>" + value.vachanam +"</td>" +                                            
                                            "<td width='10%'>" + value.lesson + "</td>" +   
                                            "<td width='5%'>"+ value.orderno +"</td>" +
                                            "<td width='5%'>" + value.status + "</td>" +
                                            "<td width='10%'>" +                                            
                                            "<a href='dailyquotes_edit.php?id="+value.dailyid+"'><i class='fa fa-pencil-square-o pointer_link_blue' aria-hidden='true'></i></a>&nbsp;&nbsp;&nbsp;" +
                                            "<i class='fa fa-trash-o pointer_link_red' aria-hidden='true' onClick='deleteItem(" + value.dailyid + ",this)'></i>" +
                                            "</td>" +
                                            "</tr>";
                                    });
                                    html += "</tbody></table>";
					...
					callback: function(result) {
						if (result) {
							...
							$.ajax({
								...
								url: "dailyquotes_delete.php?delid=" + id, // get the route value								
