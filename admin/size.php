...
<body>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card" style="overflow:scroll;">
            ...
            <a href="size_add.php"><input type="button" name="btnNew" id="btnNew" value="New" class="btn btn-primary"></a>
            </p>
        ...
        $(document).ready(function() {
            ...
            window.all = function() {
                        ...
                        $.ajax({
                            ...
                            url: 'size_all.php', // get the route value
                                ...
                                if (response.length) {
                                    ...
                                    $.each(response, function(key, value) {
                                        ...
                                        html += "<tr>" +
                                            ...
                                            "<td width='20%'><b>" + value.size + "</b></td>" +     
                                            "<td width='20%'><b>" + value.orderno + "</b></td>" +                                          
                                            "<td width='25%'>" + value.aboutsize + "</td>" +        
                                            "<td width='10%'>" +                                            
                                            "<a href='size_edit.php?id="+value.size_id+"'><i class='fa fa-pencil-square-o pointer_link_blue' aria-hidden='true'></i></a>&nbsp;&nbsp;&nbsp;" +
                                            "<i class='fa fa-trash-o pointer_link_red' aria-hidden='true' onClick='deleteItem(" + value.size_id + ",this)'></i>" +
                                            "</td>" +
                                            "</tr>";
                                    });
                                    html += "</tbody></table>";
					...
					callback: function(result) {
						if (result) {
							...
							$.ajax({
								...
								url: "size_delete.php?delid=" + id, // get the route value								
