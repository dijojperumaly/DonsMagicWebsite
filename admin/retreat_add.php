...
<body>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card"><a href='retreat.php'><< back to list</a>
            <div class="card-body">
            <h4 class="card-title">ADD RETREAT</h4>            
            </p>
                    ...
                    <form method="post" action="retreat_save" id="form_save" name="form_save" enctype="multipart/form-data">                        
                        ...
                        <?php 
                            ...
                            <select name="retreattype" id="retreattype" class="form-control">
                                ...
                                ?>
                                <option value="<?php echo $id; ?>"><?php echo $retreattype; ?></option>
                                <?php
                                }
                        ...
                        <div class="form-group">
                            <input type="text" name="title" id="title" required="true" class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            <textarea name="matter" id="matter" class="form-control" required="true" rows="7"></textarea>
                        </div>
                        <label for="field-1-3" style="clear:both;">Retreat Start Date/Time&nbsp;
                            <span class="at-required-highlight"></span>
                        </label><br>
                        <div class="form-group col-lg-6 col-md-6"  style="float:left;">
                            <input type="date" name="retreatstartdate" id="retreatstartdate" class="form-control">
                        </div>
                        <div class="form-group col-lg-6 col-md-6" style="float:left;">
                            <input type="time" name="retreatstarttime" id="retreatstarttime" class="form-control">
                        </div><br>
                        <label for="field-1-3" style="clear:both;">Retreat End Date/Time&nbsp;
                            <span class="at-required-highlight"></span>
                        </label><br>
                        <div class="form-group col-lg-6 col-md-6"  style="float:left;">
                            <input type="date" name="retreatenddate" id="retreatenddate" class="form-control">
                        </div>
                        <div class="form-group col-lg-6 col-md-6" style="float:left;">
                            <input type="time" name="retreatendtime" id="retreatendtime" class="form-control" placeholder="Time">
                        </div><br>
                        <label for="field-1-3">No of Days&nbsp;
                            <span class="at-required-highlight"></span>
                        </label>
                        <div class="form-group">
                            <input type="number" name="nodays" id="nodays" class="form-control">
                        </div>  
                        ...
                        <div class="form-group">
                            <input type="text" name="venu" id="venu" class="form-control">
                        </div>    
