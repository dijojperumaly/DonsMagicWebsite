...
CREATE TABLE IF NOT EXISTS `tbl_availablesizes` (
  `availablesize_id` int DEFAULT NULL,
...
INSERT INTO `tbl_product` (`id`, `producttype_id`, `product_code`, `title`, `aboutproduct`, `MRP`, `offerprice`, `isfeatured`, `image_1`, `image_2`, `image_3`, `image_4`, `orderno`, `availablesizes`, `createdat`, `createdby`, `updatedat`, `updatedby`, `status`, `isdeleted`) VALUES
	(6, 3, 'KF42576', 'test product edit', 'asas', 300, 200, 1, '240606011822000000370571.jpg', NULL, NULL, NULL, 1, NULL, '2024-06-06 00:05:00', 3, '2024-06-06 01:22:00', 3, 'Active', 0),
	(7, 3, 'MW72287', 'rfgt', 'fr', 45, 5, 0, '', NULL, NULL, NULL, 4, NULL, '2024-06-06 00:17:00', 3, NULL, NULL, 'Draft', 0);
...
INSERT INTO `tbl_size` (`size_id`, `size`, `aboutsize`, `orderno`, `createdat`, `createdby`, `updatedat`, `updatedby`, `status`, `isdeleted`) VALUES
	(NULL, 'S', 'Small Size', 1, '2024-06-10 15:32:00', 3, NULL, NULL, 'Active', 0),
	(NULL, 'M', 'Medium Size', 2, '2024-06-10 15:33:00', 3, NULL, NULL, 'Active', 0);
